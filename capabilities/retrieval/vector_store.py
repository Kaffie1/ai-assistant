...
from capabilities.memory.long_term.types import VectorMatch, VectorStoreProtocol
...
def create_vector_store_from_env() -> VectorStoreProtocol:
    ...
    """
    backend = MAMGA_VECTOR_BACKEND
    collection = MAMGA_COLLECTION
    ...
    try:
        ...
        return ChromaVectorStore(
            ...
            persist_directory=MAMGA_CHROMA_DIR,
        )
    except Exception:
