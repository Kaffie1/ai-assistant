...
from foundation.config import MAMGA_EMBED_MODEL, MAMGA_EMBED_PROVIDER
...
def build_embedding_provider_from_env() -> EmbeddingProvider:
    """按统一配置选择 embedding 提供方，失败时回退 hash。"""
    provider = MAMGA_EMBED_PROVIDER
    model = MAMGA_EMBED_MODEL
